...
//
// Copyright (c) 2022 - 2025, © Badassops LLC / Luc Suryo
// All rights reserved.
//
...
func LogIt(logMsg string, logLevel string, enable bool) {
	if enable {
		Log(strings.TrimSuffix(logMsg, "\n"), logLevel)
	}
}
...
func InitLogs(c *vars.LogConfig) {
